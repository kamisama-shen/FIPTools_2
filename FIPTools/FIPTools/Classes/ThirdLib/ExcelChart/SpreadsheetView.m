...
- (NSArray<ZMJCell *> *)visibleCells {
    ...
    for (Address *address in self.columnHeaderView.visibleCells.array) {
        ZMJCell *cell = [self cellForItemAt:[NSIndexPath indexPathWithRow:address.row column:address.column]];
        [cells addObject:cell];
    }
    for (Address *address in self.rowHeaderView.visibleCells.array) {
        ZMJCell *cell = [self cellForItemAt:[NSIndexPath indexPathWithRow:address.row column:address.column]];
        [cells addObject:cell];
    }
    for (Address *address in self.cornerView.visibleCells.array) {
        ZMJCell *cell = [self cellForItemAt:[NSIndexPath indexPathWithRow:address.row column:address.column]];
        [cells addObject:cell];
    }
    for (Address *address in self.tableView.visibleCells.array) {
        ZMJCell *cell = [self cellForItemAt:[NSIndexPath indexPathWithRow:address.row column:address.column]];
        [cells addObject:cell];
    }
