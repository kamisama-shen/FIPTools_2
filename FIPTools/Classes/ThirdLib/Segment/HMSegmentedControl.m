...
- (void)setBorderCorner:(CGFloat)borderCorner{
    ...
    self.selectionIndicatorBoxLayer.cornerRadius = borderCorner;
    
//    for (CALayer *layer in _titleBackgroundLayers) {
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.type == HMSegmentedControlTypeText) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleFullWidthReduce80Stripe){
            sectionWidth = self.segmentWidth - 80;
        }else{
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleFullWidthReduce80Stripe&&sectionWidth <= self.segmentWidth &&
       ...
       else if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
